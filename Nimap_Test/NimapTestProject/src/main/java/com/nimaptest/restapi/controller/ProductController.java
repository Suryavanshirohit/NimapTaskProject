...
public class ProductController {
	...
	public ResponseEntity<Response<Page<ProductDTO>>> getAllproducts(@RequestParam int page,
		...
		Page<ProductDTO> categoriesPage = productService.getAllProducts(pageable);
	...
	public ResponseEntity<Response<ProductDTO>> addProduct(@RequestBody ProductDTO p) {
		ProductDTO product = productService.addProduct(p);
	...
	public ResponseEntity<Response<ProductDTO>> findProductById(@PathVariable("id") int id) {
